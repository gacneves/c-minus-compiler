...
typedef enum{
    ADD, SUB, MUL, DIV, NOT, AND, OR, XOR, SLT, SGT, JR, IN, OUT, ADDI, SUBI, BEQ, BNEQ, LW, SW, SR, SL, J, JAL, NOP, HLT, FINALIZE, PREEMPON, PREEMPOFF, MEMCTRL, HDTOINST, HDTOREG, REGTOHD
}InstructionKind;
